sap.ui.define([
		...
		return BaseObject.extend("products.list.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias products.list.model.ListSelector
			 */
			 ...
			 * @return {products.list.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
