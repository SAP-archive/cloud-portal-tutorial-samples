/*global history */
sap.ui.define([
		"products/list/controller/BaseController",
		...
		"sap/ui/Device",
		"products/list/model/formatter",
		"products/list/model/grouper",
		...
		return BaseController.extend("products.list.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("products.list.view.ViewSettingsDialog", this);
